...
const ForgotForm = () => {
   ...
   return (
      <section className="eg-login__area pb-120 p-relative z-index-1 fix pt-120">
                           ...
                           <div className="eg-login__input-wrapper">
                              <div className="eg-login__input-box">
                                 <div className="eg-login__input">
                                    ...
                                    <input id="email" {...register("email")} type="email" placeholder="suxnix@mail.com" />
                                    <p className="form_error">{errors.email?.message}</p>
                                 </div>
                              </div>
                           </div>
                           <div className="eg-login__bottom mt-30">
                              <button type="submit" className="eg-btn w-100">Send Mail</button>
                           </div>
